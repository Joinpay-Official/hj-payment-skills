...
public class JoinPayNativePayTest {
    ...
    static final String TRADE_MERCHANT_NO = "your_trade_merchant_no";         // 报备商户号（必填，在商户后台「报备管理」获取）
    static final String NOTIFY_URL        = "http://localhost:8080/notify_url.jsp"; // 回调地址（允许本地调试）
